                ...
                <div class="card-header">
                    <ul class="nav nav-tabs">
                        ...
                        <li role="tab1" class="@if($tab==1){{"active"}}@endif">
                            <a href="#tab1" aria-controls="tab1" role="tab" data-toggle="tab">学期列表</a>
                        </li>
                        <li role="tab2" style="width:160px" class="@if($tab==2){{"active"}}@endif">
                            <a href="#tab2" aria-controls="tab2" role="tab" data-toggle="tab">添加新学期</a>
                        </li>
                    </ul>
                </div>
                        ...
                        <table class="datatable table" cellspacing="0" width="100%">
                            ...
                            @foreach($members as $member)
                                <tr>
                                    ...
                                    <td>{{$member->name}}</td>
                                    <td>
                                        <a href="{{url("deleteterm/$member->id")}}">
                                            ...
                                            <div class="section">
                                                <div class="section-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">学期名称</label>
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" placeholder="例如:2016-2017学年" name="name">
                                                        </div>
                                                    </div>
